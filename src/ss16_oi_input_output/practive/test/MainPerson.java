package ss16_oi_input_output.practive.test;
...
MainPerson {
    ...
    public static void main(String[] args) {
        ...
        Person Iperson = new Person(Integer.parseInt(lineSplit[0]), lineSplit[1], lineSplit[2]);

        System.out.println(Iperson.getId() + " " + Iperson.getName()+" "+Iperson.getDateOfBirth());
